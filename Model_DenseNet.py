...
def Model_DenseNet(train_data, Target, test_data, test_tar):
    IMG_SIZE = [32, 32, 3]
    ...
    model.fit(train_data, Target, steps_per_epoch=100, batch_size=48, epochs=10, validation_data=(test_data, test_tar) )
